...
Q_IMPORT_QML_PLUGIN(ActivityViewDemoContentPlugin)
Q_IMPORT_QML_PLUGIN(ActivityViewDemoPlugin)

const char mainQmlFile[] = "qrc:/qt/qml/ActivityViewDemoContent/App.qml";
